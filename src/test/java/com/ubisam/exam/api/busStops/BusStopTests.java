...
public class BusStopTests {
  ...
  void contextLoads() throws Exception{
    // Crud - C
    mvc.perform(post("/api/busStops").content(docs::newEntity, "어반워크정류장")).andDo(print()).andExpect(is2xx()).andDo(result(docs::context, "entity1"));
  ...
  void contextLoads3 () throws Exception{
    ...
    mvc.perform(post(uri).content(docs::setSearchLocation, "서울시1")).andExpect(is2xx());
